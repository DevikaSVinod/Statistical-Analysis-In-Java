...
//                 System.out.println("Column " + headers[colIndex] + ":");
//                 System.out.println("\tMinimum value: " + min);
//                 System.out.println("\tMaximum value: " + max);
//                 System.out.println("\tRange: " + range + "\n");
//             } else {
//                 System.out.println("Column " + headers[colIndex] + " - No numerical data found.\n");
//             }
//         }
//     }
...
//         data.add(new String[]{"1.2", "5.6", "abc"});
//         data.add(new String[]{"2.3", "7.8", "10.1"});
//         data.add(new String[]{"4.5", "1.2", "3.4"});
//         data.add(new String[]{"", "9.0", "5.6"});

//         calculateMinMaxRangeForColumns(data);
//     }
// }
